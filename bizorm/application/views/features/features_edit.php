    ...
    <div class="row pt-5">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="image1" name="icon1" value="<?php echo $edit->icon1;?>">
              </div>
    ...
    <div class="row pt-5">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control"   placeholder="Enter sub-description" id="sub_description2" name="sub_description2" value="<?php echo $edit->sub_description2;?>">
              </div>
    ...
    <div class="row pt-5">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter sub-description" id="sub_description3"  name="sub_description3" value="<?php echo $edit->sub_description3;?>">
              </div>
            
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="image3">Icon3 3:</label>
    ...
    <div class="row pt-5">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter sub-description"  id="sub_description" name="sub_description4" value="<?php echo $edit->sub_description4;?>">
              </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-contro4" id="image4" name="icon4" value="<?php echo $edit->icon4;?>">
              </div>
    ...
    <div class="row pt-5">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="image1" name="icon5" value="<?php echo $edit->icon5;?>">
              </div>
    ...
    <div class="row pt-5">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="file" class="form-control" id="image6" name="image" value="<?php echo $edit->image;?>"> 
              </div>
        </div>
        <!-- <div class="col-md-6">
            <div class="form-group">
